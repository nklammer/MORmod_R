...
#fit <- pvclust(t(df)[1:20, 1:20], method.hclust="ward", method.dist="euclidean")
fit <- pvclust(t(df), method.hclust="ward", method.dist="euclidean", nboot = 100)

...
In this case C, I am comparing a reduced model with clustering basis in `hvac_dhw_novar`, with a full model `hvac_dhw_var`.

## Import Rda data

```{r import, message=FALSE, warning=FALSE}
load(file = "~/MORmod_R/files/hvac_dhw_var.Rda")
load(file = "compare_C.Rda")

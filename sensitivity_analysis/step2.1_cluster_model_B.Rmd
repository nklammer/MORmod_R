...
if ("minute" %in% colnames(df_cluster)) {
  df_cluster <- subset(df_cluster, select = -c(day, hour, month, minute, hour_index))
} else {
  df_cluster <- subset(df_cluster, select = -c(day, hour, month, hour_index))
}

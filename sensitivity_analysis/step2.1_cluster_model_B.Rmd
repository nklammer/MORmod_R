...
In this case I'm using `ilas_dhw_novar` dataframe to cluster but I'm reducing the  `hvac_dhw_var` dataframe.
...
### Save out
compare_B <- red_df
save(compare_B, file = "compare_B.Rda")
```

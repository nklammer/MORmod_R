...
area_idx <- sapply(colnames(df), maps_name_to_index) # maps df index to area index
...
### Save out
hvac_dhw_novar_red <- red_df
save(hvac_dhw_novar_red, file = "~/MORmod_R/files/hvac_dhw_novar_red.Rda")
```
